class ZCL_LGTICA_PROYECTOS definition
  public
  inheriting from ZCL_LGTICA_DOCUMENTO
  final
  create public .

*"* public components of class ZCL_LGTICA_PROYECTOS
...
CLASS ZCL_LGTICA_PROYECTOS IMPLEMENTATION.
...
* Información General
*-------------------------------------------------------------------------------*
* Descripción  : Entregas para Proceso Proyectos
...
* Información General
*-------------------------------------------------------------------------------*
* Descripción  : Cabecera de Documentos para Ordenes de Servicio en Proyectos
* Autor Prog.  : Marco Suarez
...
*{   INSERT         ER3K900279                                        6
            IF I_FLAG_DET is not INITIAL.
*.....Busco Registros que esten Pendiente por Picking con el Número Doc Recibido
        READ TABLE lti_vbup WITH KEY vbeln = <lfs_vbak>-vbeln "i_documento_origen
                                    ASSIGNING <lfs_vbup>.
        IF sy-subrc EQ 0.
...
* Información General
*-------------------------------------------------------------------------------*
* Descripción  : Detalle de Documentos Ordenes de Servicio en Proyectos
* Autor Prog.  : Marco Suarez
